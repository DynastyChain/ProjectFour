...
angular.module('projectFourApp')
  .controller('JulCtrl', function($http, localStorageService) {
    ...
    function getBudget() {
      vm.budget = localStorageService.get('julBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('julBudget')
      localStorageService.set('julBudget', vm.budChange);
      vm.getBudget();
    }
