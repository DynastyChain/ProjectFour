...
angular.module('projectFourApp')
  .controller('JanCtrl', function($http, localStorageService) {
    ...
    function getBudget() {
      vm.budget = localStorageService.get('janBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('janBudget')
      localStorageService.set('janBudget', vm.budChange);
      vm.getBudget();
    }
