...
angular.module('projectFourApp')
  .controller('MarCtrl', function($http, localStorageService) {
    ...
    function getBudget() {
      vm.budget = localStorageService.get('marBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('marBudget')
      localStorageService.set('marBudget', vm.budChange);
      vm.getBudget();
    }
