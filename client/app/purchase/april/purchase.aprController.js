...
angular.module('projectFourApp')
  .controller('AprCtrl', function($http, localStorageService) {
    ...
    function getBudget() {
      vm.budget = localStorageService.get('aprBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('aprBudget')
      localStorageService.set('aprBudget', vm.budChange);
      vm.getBudget();
    }
