...
angular.module('projectFourApp')
  .controller('MayCtrl', function($http, localStorageService) {
    ...
    function getBudget() {
      vm.budget = localStorageService.get('mayBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('mayBudget')
      localStorageService.set('mayBudget', vm.budChange);
      vm.getBudget();
    }
