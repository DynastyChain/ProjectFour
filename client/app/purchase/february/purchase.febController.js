...
angular.module('projectFourApp')
  .controller('FebCtrl', function($http, localStorageService) {
    ...
    vm.month = {name: 'february', total: 0}
    vm.count = 1
    ...
    function getBudget() {
      vm.budget = localStorageService.get('febBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('febBudget')
      localStorageService.set('febBudget', vm.budChange);
      vm.getBudget();
    }
