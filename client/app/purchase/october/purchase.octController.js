...
angular.module('projectFourApp')
  .controller('OctCtrl', function($http, localStorageService) {
    ...
    function getBudget() {
      vm.budget = localStorageService.get('octBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('octBudget')
      localStorageService.set('octBudget', vm.budChange);
      vm.getBudget();
    }
