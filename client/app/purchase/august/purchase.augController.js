...
angular.module('projectFourApp')
  .controller('AugCtrl', function($http, localStorageService) {
    ...
    function getBudget() {
      vm.budget = localStorageService.get('augBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('augBudget')
      localStorageService.set('augBudget', vm.budChange);
      vm.getBudget();
    }
