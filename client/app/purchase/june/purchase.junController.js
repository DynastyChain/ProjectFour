...
angular.module('projectFourApp')
  .controller('JunCtrl', function($http, localStorageService) {
    ...
    function getBudget() {
      vm.budget = localStorageService.get('junBudget');
      return vm.budget
    }
    function changeBudget() {
      localStorageService.remove('junBudget')
      localStorageService.set('junBudget', vm.budChange);
      vm.getBudget();
    }
